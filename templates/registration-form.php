    ...
    <form class="registration__form form" action="/registration.php" method="post" enctype="multipart/form-data">
      <div class="form__text-inputs-wrapper">
        <div class="form__text-inputs">
          <div class="registration__input-wrapper form__input-wrapper<?= add_class(!empty($errors['email']), 'form__input-section--error') ?>">
          ...
          <div class="registration__input-wrapper form__input-wrapper<?= add_class(!empty($errors['login']), 'form__input-section--error') ?>">
          ...
          <div class="registration__input-wrapper form__input-wrapper<?= add_class(!empty($errors['password']), 'form__input-section--error') ?>">
          ...
          <div class="registration__input-wrapper form__input-wrapper<?= add_class(!empty($errors['password-repeat']), 'form__input-section--error') ?>">
