    ...
    <section class="authorization">
      ...
      <form class="authorization__form form" action="/index.php" method="post">
        <div class="authorization__input-wrapper form__input-wrapper">
          <div class="form__input-section<?= add_class(!empty($errors['login']), 'form__input-section--error') ?>">
            <input
        ...
        <div class="authorization__input-wrapper form__input-wrapper">
          <div class="form__input-section<?= add_class(!empty($errors['password']), 'form__input-section--error') ?>">
            <input
